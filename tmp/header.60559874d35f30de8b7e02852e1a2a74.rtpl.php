...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!-- MORRIS CHART STYLES-->
        <link href="templates/assets/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
        <!-- dataTables -->
        <link href="templates/assets/js/dataTables/dataTables.bootstrap.css" rel="stylesheet" />
        <link href="templates/../templates/assets/css/datatables.min.css" rel="stylesheet" />
        <!-- CUSTOM STYLES-->
        ...
        <div id="wrapper">
            <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/index.php">Moataz CMS</a>
                </div>
            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li  >
                            <a  href="/index.php"><i class="fa fa-paste fa-3x"></i>Articles</a>
                        </li>
                        <li  >
                            <a  href="/table.html"><i class="fa fa-users fa-3x"></i>Users</a>
                        </li>
                        <li  >
                            <a  href="/table.html"><i class="fa fa-youtube fa-3x"></i>Youtube</a>
                        </li>
