    ...
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="/addArticle.php" class="btn btn-primary square-btn-adjust">Add Article</a>
            </div>
        </div>
        <hr />
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h1><a href="/article.php?id=<?php echo $value1["id"];?>" ><?php echo $value1["title"];?></a></h1>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div>
                                ...
                                <div class="pull-right"><a href="/cat.php?id=<?php echo $value1["cid"];?>" target="_blank" ><span class="label label-warning"><?php echo $value1["cname"];?></span></a> </div>         
                            </div>
                        </div>
