...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!-- BOOTSTRAP STYLES-->
        <link href="/opt/lampp/htdocs/AhmedSyamRoutingtemplates/assets/css/bootstrap.css" rel="stylesheet" />
        <!-- FONTAWESOME STYLES-->
        <link href="/opt/lampp/htdocs/AhmedSyamRoutingtemplates/assets/css/font-awesome.css" rel="stylesheet" />
        <!-- MORRIS CHART STYLES-->
        <link href="/opt/lampp/htdocs/AhmedSyamRoutingtemplates/assets/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
        <!-- dataTables -->
        <link href="/opt/lampp/htdocs/AhmedSyamRoutingtemplates/assets/js/dataTables/dataTables.bootstrap.css" rel="stylesheet" />
        <link href="/opt/lampp/htdocs/AhmedSyamRoutingtemplates/../templates/assets/css/datatables.min.css" rel="stylesheet" />
        <!-- CUSTOM STYLES-->
        <link href="/opt/lampp/htdocs/AhmedSyamRoutingtemplates/assets/css/custom.css" rel="stylesheet" />
        <!-- GOOGLE FONTS-->
        <!--
