                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div>
                                ...
                                <div class="pull-right"><a href="http://localhost/AhmedSyamRouting/cats/show/<?php echo $value1["cid"];?>"  ><span class="label label-warning"><?php echo $value1["cname"];?></span></a> </div>         
                            </div>
                        </div>
